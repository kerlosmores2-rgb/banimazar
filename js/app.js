...
async function loadAllDataFromSupabase() {
    ...
    await loadFromSupabase('monthly_costs', 'monthlyCosts');
    await loadFromSupabase('daily_reports', 'dailyReports');
...
// تعديل localStorage.setItem عشان يزامن مع Supabase
...
localStorage.setItem = function(key, value) {
    ...
    else if (key === 'monthlyCosts') syncToSupabase('monthly_costs', 'monthlyCosts');
    else if (key === 'dailyReports') syncToSupabase('daily_reports', 'dailyReports');
};
// ==================== الاتصال بـ Supabase ====================
const SUPABASE_URL = 'https://pbzpumetrmirnsshjdoe.supabase.co';
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBienB1bWV0cm1pcm5zc2hqZG9lIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzQxMTY5MDAsImV4cCI6MjA4OTY5MjkwMH0.8x1YGOdmj0YZJz_KGxC5Awk4S6bc1dvI9BcVKjGkTO8';
